...
class ObjectDetectorNode:
    def __init__(self):
        ...
        # weights 경로 처리 ($(find autocal) 치환)
        raw_weights = rospy.get_param("~detector/weights", "$(find autocal)/models/yolo11m.pt")
        ...
        self.pub_topic = rospy.get_param("~topics/detections_out", "/autocal/detections_raw")
        self.debug_topic = rospy.get_param("~topics/debug_image", "/autocal/detector_debug")
