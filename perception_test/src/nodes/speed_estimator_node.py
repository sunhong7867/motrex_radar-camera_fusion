...
데이터 흐름:
[Association Node] (/perception_test/associated)
       ⬇
[Speed Estimator] (Gating -> Bias -> KF)
       ⬇
[Final Output] (/perception_test/associated_speed)
"""

import rospy
import numpy as np
from collections import deque
from perception_test.msg import AssociationArray, Association
...
class SpeedEstimatorNode:
    def __init__(self):
        ...
        # --- 파라미터 설정 ---
        # 입력/출력 토픽
        self.sub_topic = rospy.get_param("~in_topic", "/perception_test/associated")
        self.pub_topic = rospy.get_param("~out_topic", "/perception_test/associated_speed")
