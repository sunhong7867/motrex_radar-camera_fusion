...
from perception.msg import DetectionArray
...
class CalibrationManager:
    def __init__(self):
        ...
        self.save_path = os.path.join(rospack.get_path('perception'), 'src', 'nodes', 'extrinsic.json')

        # 토픽 구독 (Time Synchronizer 사용)
        self.sub_det = message_filters.Subscriber('/perception/detections', DetectionArray)
