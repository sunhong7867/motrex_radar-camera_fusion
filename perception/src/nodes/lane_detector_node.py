...
데이터 흐름:
[Object Detector] (/perception/detections_raw)
       ⬇
[Lane Detector]   (필터링 수행)
       ⬇
[Association Node] (/perception/detections)
"""
...
class LaneDetectorNode:
    def __init__(self):
        ...
        self.sub_topic = rospy.get_param("~input_topic", "/perception/detections_raw")
        # 출력: 차선 필터링이 끝난 결과 (Association 노드가 받을 토픽)
        self.pub_topic = rospy.get_param("~output_topic", "/perception/detections")
